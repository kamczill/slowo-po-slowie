...
const ShopPage = () => {
  return (
    <div className='bg-[#F6F6F6] min-h-[50vh] w-full flex flex-col items-center '>
        <div className='mt-12 py-8 max-w-[1400px] px-6 w-full md:px-8 flex flex-col gap-8 md:flex-row lg:px-14'>
        <ShopNav />
        
        <div className='bg-white w-full p-6'>
            <h2 className='font-semibold text-3xl text-left'>Karty do gry</h2>
