...
const ProductBanners = () => {
  return (
    ...
    <div className="flex w-full max-w-[1200px] flex-col gap-12 rounded-xl bg-[#F6F6F6] py-6 lg:flex-row lg:justify-between">
        <CategoryBanner img={ebookImg} alt='Gra Logopedyczna Dla Dzieci' to='' title='Karty do gry'/>
        <CategoryBanner img={graImg} alt='Gra Logopedyczna Dla Dzieci' to='' title='E-booki' />
    </div>
  </div>  )
}
