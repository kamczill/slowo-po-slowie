...
const AboutFounder = () => {
  return (
    <div className='flex items-center justify-center '>
        <article className='flex flex-col  md:flex-row md:gap-6 md:items-center md:justify-center w-full max-w-[1200px] p-6 lg:justify-center lg:gap-[200px]'>
            <div className='flex flex-col items-center gap-6'>
                <h2 className='hidden font-semibold text-xl text-left w-full md:flex flex-col md:text-3xl'>Założycielka <span>Słowo po słowie</span></h2>
            ...
            <div className='flex flex-col items-center justify-center md:items-start lg:items-end h-full lg:self-end md:mt-[90px] lg:mt-0 p-4 bg-white rounded-lg'>
                <h3 className='text-center font-semibold text-xl md:text-left lg:hidden'>Anna Stachowiak</h3>
                <p className='px-6 pt-2 text-justify max-w-[500px] md:text-left md:px-0 lg:max-w-[350px] lg:text-justify bg-white'>
