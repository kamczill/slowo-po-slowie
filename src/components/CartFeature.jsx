...
const CartFeature = ({onClick}) => {
  return (
    <div className='fixed z-10 top-20 bg-slate-100 w-screen right-0 p-6 flex flex-col justify-between min-h-[400px] max-w-[500px] gap-5 sm:right-20 sm:top-[90px] md:absolute md:right-6 md:top-[100px]'>
        <div>
        ...
        <div className='flex flex-col gap-2 items-start'>
            ...
            <button onClick={onClick} className='rounded-xl bg-[#303030] text-white py-2 px-6 w-full text-lg'><Link to='/koszyk'>Przejdź do koszyka</Link></button>
