    ...
    return (
        <article className='relative flex flex-col gap-6 max-w-[470px] md:flex-row md:max-w-full md:justify-center md:items-center'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <Link className='uppercase text-lg inline-flex items-center justify-center gap-2 md:justify-start' to={url}>czytaj dalej <IoChevronForward className='text-2xl' /> </Link>
            </div>
